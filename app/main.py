...
def add_predictions(input_data):
    ...
    if prediction[0] == 0:
        ...
        st.write("<span class='diagnosis error'>Opps.. Error!</span>", unsafe_allow_html=True)
...
def main():
    ...
    with st.container():
        st.title("CancerIQ: Fast, AI-Powered Diagnosis")
        st.write("Connect this app to your cytology lab for enhanced breast cancer diagnosis. "
        "Using a machine learning model, the app predicts if a breast mass is benign or malignant "
        "based on lab measurements. You can also input measurements manually using the sliders in the sidebar for flexible analysis.")
